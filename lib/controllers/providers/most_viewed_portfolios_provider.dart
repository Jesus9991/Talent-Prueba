...
/*
PROVIDER: talento mas visto
*/
class MostViewedPortfoliosProvider extends ChangeNotifier {
  /*inicia los datos al llamar al provider*/
  MostViewedPortfoliosProvider() {
    getListTalentMostViewed();
  }

  /*modelo de los datos*/
  MostViewedPortfoliosModels _portafolioModel = MostViewedPortfoliosModels(
    count: 0,
    data: [],
    image: '',
  ...
  MostViewedPortfoliosModels get talentModel => _portafolioModel;
  ...
  //*PETICION PARA OBTENER LA LISTA DE PORTAFOLIOS MAS VISTOS DEL HOME
  Future getListTalentMostViewed() async {
    try {
      setIsLoading(true);

      final url =
          Uri.parse('${UrlApiPath.urlHttp}${PathApi.portafoliMostView}');
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        log('error en _portafolioModel ${response.statusCode}');
      }
    } on TimeoutException {
