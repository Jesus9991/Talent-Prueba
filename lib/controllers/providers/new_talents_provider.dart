...
/*
PROVIDER: nuevos talentos 
*/
class NewTalentsProvider extends ChangeNotifier {
  ...
  /*modelo de los datos*/
  NewTalentModels _talentModel = NewTalentModels(
    count: 0,
    data: [],
    image: '',
    key: 'most_new_talent',
  ...
  NewTalentModels get talentModel => _talentModel;
  ...
  Future getListNewTalent() async {
    try {
      setIsLoading(true);

      final url = Uri.parse('${UrlApiPath.urlHttp}${PathApi.newTalent}');
